...
class MoviesViewModelFactory @Inject constructor(private var providerMap: Map<Class<out ViewModel>, @JvmSuppressWildcards Provider<ViewModel>>) : ViewModelProvider.Factory {
